...
Copyright (c) 2014, Simran (http://materialdesignicons.com/),
...
private const val PATH_HANDSHAKE =
...
private const val PATH_HUMIDITY =
...
enum class Vector(
    ...
    HANDSHAKE(PATH_HANDSHAKE, color = ThemedColor.PRIMARY),
    HUMIDITY(PATH_HUMIDITY, color = ThemedColor.PRIMARY),
